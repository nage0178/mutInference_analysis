means <- read.table("~/mutInference_analysis/simulations/recombination/means", header =TRUE)
stdev <- read.table("~/mutInference_analysis/simulations/recombination/variance", header =TRUE)
ESS <-   read.table("~/mutInference_analysis/simulations/recombination/ESS", header =TRUE)
