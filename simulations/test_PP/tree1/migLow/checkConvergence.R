print("read 0")
means <- read.table("~/AlPop/tree1/migLow/means", header =TRUE)
print("read 1")
stdev <- read.table("~/AlPop/tree1/migLow/variance", header =TRUE)
ESS <-   read.table("~/AlPop/tree1/migLow/ESS", header =TRUE)
