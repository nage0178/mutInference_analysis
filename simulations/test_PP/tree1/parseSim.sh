...
echo rep,locus,site,time,base,pop,mean_time,time_25,time_975,popA,popB,popC,popD,popAB,popCD,popABCD,mutA,mutC,mutG,mutT > summary2
...
do
	...
	do
		...
		#	echo $siteCol
			...
			popCD=$(grep -w "1_mut_pop_CD" 2out${locus} | awk -v col="$siteCol" '{ print $col }')
			...
			if  ((passSiteCol==1)); then
				...
				echo ${rep},${simSum},${time},${time25},${time975},${popA},${popB},${popC},${popD},${popAB},${popCD},${popABCD},${mutA},${mutC},${mutG},${mutT} >> ../summary2
			fi 
